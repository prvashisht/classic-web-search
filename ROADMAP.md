...
1. Replace DOM-click redirect with direct URL rewriting.
...
2. Add redirect loop protection and URL guards.
...
3. Restore extension state on service worker startup.
...
4. Harden background URL handling.
...
2. Add a local packaging script.
...
4. Add store deployment workflows.
...
3. Add issue-management workflows.
